...
# as an example, if you fork invenio-rdm-records uncomment this line:
...
# pipenv run invenio-cli packages install  /workspaces/rdm-instance/forked-rdm-repos/invenio-rdm-records /workspaces/rdm-instance/forked-rdm-repos/invenio-app-rdm /workspaces/rdm-instance/forked-rdm-repos/invenio-requests 
